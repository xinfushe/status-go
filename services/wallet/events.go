...
const (
	...
	// EventFetchingRecentHistory emmited when fetching of lastest tx history is started
	EventFetchingRecentHistory EventType = "recent-history-fetching"
	// EventRecentHistoryFetched emmited when fetching of lastest tx history is started
